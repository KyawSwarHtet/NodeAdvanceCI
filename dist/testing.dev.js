...
/******************************************************************************** */
var getFirstUniq = function getFirstUniq(numList) {
  var numCounts = {}; //Count for each number
  ...
  try {
    for (var _iterator = numList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var num = _step.value;
  ...
  console.log("numlist", numCounts); //Find the first unique number
  ...
  try {
    for (var _iterator2 = numList[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var testArray = [2, 3, 4, 5, 3, 7, 2, 8];
var firstUnique = getFirstUniq(testArray);
